...
public class PivotArmFalcon extends Subsystem {
      private double m_targetAngle;
      private double m_currentAngle;
      private PivotArmObject Pivot;
      private static PivotArmFalcon m_instance;
      ...
      public void initDefaultCommand() 
	{
      ...
      public synchronized static PivotArmFalcon getInstance() {
            if (m_instance == null) m_instance = new PivotArmFalcon();
            return m_instance;
          }
      private PivotArmFalcon(){
