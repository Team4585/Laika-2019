...
/*
 * Creates Victor SPX objects and configures all the parameters we care about to factory defaults. Closed-loop and sensor
...
public class VictorSPXFactory {
    ...
    public static VictorSPX createPermanentSlaveVictorSPX(int id, int master_id) {
    ...
    public static VictorSPX createVictor(int id, Configuration config) {
        ...
        //Looks for a limit switch on a remote Talon SRX (Will look at whether or not this creates bugs later on)
        victor.configForwardLimitSwitchSource(RemoteLimitSwitchSource.RemoteTalonSRX,
                LimitSwitchNormal.NormallyOpen, kTimeoutMs);
        victor.configReverseLimitSwitchSource(RemoteLimitSwitchSource.RemoteTalonSRX,
                LimitSwitchNormal.NormallyOpen, kTimeoutMs);
        ...
        /*  If someone can figure out this error and find its solution in reference to the 
         *  TalonSRXFactory class that follows this, that'd be awesome.
         * 
         * 
